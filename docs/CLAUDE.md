...
- **Current:** `v0.44.5` — F58 pinning friction/confirmation (action toast with Undo, pin badge flash, improved snap-back toast). Live at `https://adrotar21.github.io/timeline-studio/`.
