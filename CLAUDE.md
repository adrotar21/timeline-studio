...
- **Current:** `v0.40.0` — Header Bar Customization: Days timescale, format options, right-click popover, shading controls, boundary grid lines, day indicators. Live at `https://adrotar21.github.io/timeline-studio/`.
