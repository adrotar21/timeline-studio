...
- **Current:** `v0.34.3` — Critical path fix (B38): backward-pass float calculation for FS/FF constraints through milestones. Live at `https://adrotar21.github.io/timeline-studio/`.
