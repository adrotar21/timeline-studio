...
- **Current:** `v0.20.0` — comprehensive README.md documentation (F8). Screenshot guide for 5 key views. Public-facing readiness milestone.
...
```bash
node v0.20.0/test_comprehensive.js
node v0.20.0/test_expanded.js
```
