...
- **Current:** `v0.40.1` — Bugfix: header popover mousedown-level dismiss, holiday gear scroll target, canvas DPR capping for large exports. Live at `https://adrotar21.github.io/timeline-studio/`.
