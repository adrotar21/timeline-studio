...
- **Current:** `v0.35.0` — UI polish (tooltips, focus glow, scrollbars, buttons, row shading, toast/modal/dropdown animations, context menu shortcuts). Live at `https://adrotar21.github.io/timeline-studio/`.
